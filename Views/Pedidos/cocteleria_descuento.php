    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <div class="card-body">
                        <a href="<?php echo base_url; ?>Terminal/mcocteleria" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i> Regresar
                        </a>
                        <?php foreach ($data['familia'] as $familia) { ?>
                        <a href="<?php echo base_url.'Pedidos/cocteleria_descuento/'.$familia['id'];?>" class="btn">
            ...
            <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="position-relative">
                                ...
                                <div class="card">
                                    ...
                                    <input type="hidden" name="t_pedido" id="t_pedido" value="4">
                            ...
                            <div class="float-right">
                                <div class="btn-group">
                                    <?php 
                                        ...
                                        $url = base_url.'Pedidos/cocteleria_descuento/'.$data['id_familia'];
                ...
                <div class="col-md-4">
                    ...
                    <form id="frmInfoPed">
                        <input type="hidden" name="tipo_pedido" id="tipo_pedido" value="4">
                        ...
                        <div class="text-center mt-3">
                            ...
                            <select name="autorizado" id="autorizado" class="form-control" style="width: 100%; padding: 8px; font-size: 16px; text-align: center;">
                                <?php foreach ($data['autorizador'] as $row) { ?>
                        ...
                        <div class="text-center mt-3">
                            <div class="form-group">
                                <input id="fecha_desc" class="form-control" type="date" name="fecha_desc">
                            </div>
                        </div>
                        <div class="text-center mt-3">
                            <select name="trab_desc" id="trab_desc" class="form-control" style="width: 100%; padding: 8px; font-size: 16px; text-align: center;">
                ...
                <input type="hidden" id="lineaparamBusq" value="2">
