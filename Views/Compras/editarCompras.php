...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
                        ...
                        <form id="frmCompra">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button id="registrar_compra" class="btn btn-primary mt-2 btn-block" type="button" onclick="procesarCompra(event);">Generar Compra</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <script src="<?php echo base_url; ?>Assets/js/editarCompras.js"></script>
