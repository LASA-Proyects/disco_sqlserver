...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                            ...
                            <form method="post" id="frmInfoPedido">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>SERIE</label>
                                            <input id="serie_doc_vnt" class="form-control" type="text" name="serie_doc_vnt" placeholder="Serie">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>CORRELATIVO</label>
                                            <input id="correl_doc_vnt" class="form-control" type="number" name="correl_doc_vnt" placeholder="Correlativo">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        <form id="frmVenta">
                            <div class="modal-header bg-primary d-flex justify-content-center py-1">
                                <h5 class="modal-title text-white text-center" id="titulo_productos_vent"></h5>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>LIMPIAR</label>
                                            <button class="btn btn-secondary btn-block" type="button" onclick="limpiarFormVenta(event)"><i class="fas fa-broom"></i></button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>PRECIO</label>
                                            <input id="precio" class="form-control" type="number" name="precio" disabled placeholder="Precio">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <a class="btn btn-info btnAddVentas">
                                    ...
                                    <div class="col-md-12">
                                        <button id="registrar_venta" class="btn btn-primary mt-2 btn-block" type="button" onclick="procesarVenta(event);">Generar Venta</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <script src="<?php echo base_url; ?>Assets/js/editarVentas.js"></script>
            <script src="<?php echo base_url; ?>Assets/js/venta.js"></script>
            <script src="<?php echo base_url; ?>Assets/js/ventas_products.js"></script>
