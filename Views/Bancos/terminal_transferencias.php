                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="modal-body">
                            <form method="post" id="frmInfoBancoIgreso">
                                <div class="row">
                                    <div class="col-md-5">
                                        <input type="hidden" id="banco_tipo" name="banco_tipo"  value="3">
                                        <div class="form-group">
                                            <label>BANCO INICIAL</label>
                                            <select name="banco_inicial" id="banco_inicial" class="form-control" style="width: 100%;">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <select name="banco_final" id="banco_final" class="form-control" style="width: 100%;">
                                                <option disabled selected style="display:none;"></option>
                                                <?php foreach ($data['bancos_todos'] as $row) { ?>
                                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['nombre']; ?> | <?php echo $row['cuenta']; ?> | <?php echo $row['cuenta_contable']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
