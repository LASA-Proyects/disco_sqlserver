...
//		$publicKey = file_get_contents('prueba/server.pem');
                ...
                $privateKey = file_get_contents("guia_electronica/certificado_digital/$modo/server_key.pem");
                $publicKey = file_get_contents("guia_electronica/certificado_digital/$modo/server.pem");
