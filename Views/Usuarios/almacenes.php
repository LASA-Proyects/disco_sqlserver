                    ...
                    <div class="card" style="background-color: #191e2f;">
                        <div class="col-md-8 mx-auto">
                            <div class="card-header text-center">
                                <p style="color: white;">Asignar Permisos de Almacen</p>
                            </div>
                            <div class="card-body">
                                <form id="formularioAlmc" onsubmit="registrarPermisosAlmacenes(event)">
                                    <div class="row">
                                        <?php foreach ($data['datos'] as $row){?>
                                            <div class="col-md-4 text-center text-capitalize p-2">
                                                <label for="" style="color: white;"><?php echo $row['nombre'];?></label><br>
                                                <input type="checkbox" name ="permisos_almc[]" value="<?php echo $row['id']; ?>" <?php echo isset($data['asignados'][$row['id']]) ? 'checked' : '' ;?>>
                                            </div>
                                        <?php }?>
