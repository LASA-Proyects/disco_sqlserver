        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            ...
                            <div class="float-right">
                                <div class="btn-group">
                                    <?php 
                                        ...
                                        $url = base_url.'Pedidos/bebidas_combo/'.$data['id_linea'];
                ...
                <div id="obtenerDetallePedidos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                    ...
                    <div id="modalProcesarPedido" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
            ...
            <input type="hidden" id="parametroBusq" value="2">
