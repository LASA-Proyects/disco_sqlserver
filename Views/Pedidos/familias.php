...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <a href="<?php echo base_url; ?>Terminal/mbebidas" class="btn btn-secondary">
                        ...
                        <a href="<?php echo base_url.'Pedidos/familias/'.$familia['id'];?>" class="btn">
                                    ...
                                    <form id="frmPedidoIngr_<?php echo $producto['id_producto']; ?>">
                                        <div class="card-footer">
                                            ...
                                            <input type="hidden" name="t_pedido" id="t_pedido" value="1">
                                                <div class="d-flex justify-content-between align-items-center <?php echo ($producto['stock'] == 0) ? 'd-none' : ''; ?>">
            ...
            <input type="hidden" id="parametroBusq" value="1">
