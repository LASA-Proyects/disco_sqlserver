                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="modal-body">
                            <form method="post" id="frmInfoBancoIgreso">
                                <div class="row">
                                    <div class="col-md-6">
                                    <input type="hidden" id="banco_tipo" name="banco_tipo" value="2">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>DNI/RUC</label>
                                            <input type="number" name="documento" id="documento" class="form-control" placeholder="Ingrese dni o ruc">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label>NOMBRE</label>
                                            <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ingrese nombre o razón social">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>TIPO DOCUMENTO</label>
                                            <select name="tipo_documento" id="tipo_documento" class="form-control" style="width: 100%;">
                                                <option disabled selected style="display:none;"></option>
