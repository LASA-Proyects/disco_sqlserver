            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-3">
                        <a type="button" onclick="consultarValidacion(10, 'Pedidos/cocteleria_venta/');" class="card bg-primary text-decoration-none" style="display: block; text-align: center; padding: 20px; border-radius: 10px;">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <a type="button" onclick="consultarValidacion(11, 'Pedidos/cocteleria_cortesia/');" class="card bg-warning text-decoration-none" style="display: block; text-align: center; padding: 20px; border-radius: 10px;">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <a type="button" onclick="consultarValidacion(12, 'Pedidos/cocteleria_descuento/');" class="card bg-success text-decoration-none" style="display: block; text-align: center; padding: 20px; border-radius: 10px;">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <a type="button" onclick="consultarValidacion(13, 'Pedidos/cocteleria_representante/');" class="card bg-danger text-decoration-none" style="display: block; text-align: center; padding: 20px; border-radius: 10px;">
                            <div class="card-body">
