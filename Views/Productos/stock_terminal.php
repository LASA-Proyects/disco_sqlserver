                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="form-group" id="boton_stock_sin_validar">
                                    <label for="filtro_stock">STOCK</label>
                                    <button type="button" class="btn btn-success btn-block" onclick="validarStock()">
                                        <i class="fas fa-check-circle"></i> Validar
                                    </button>
                                </div>
                                <div class="form-group d-none" id="boton_stock_validado">
                                    <label for="filtro_stock_validado">STOCK VALIDADO</label>
...
<script src="<?php echo base_url; ?>Assets/js/validar_stock.js"></script>
